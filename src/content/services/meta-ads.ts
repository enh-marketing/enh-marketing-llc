...
export const resultStats = [
  { figure: "3.6", unit: "x", label: "ROAS ACHIEVED" },
  { figure: "30", unit: "%", label: "LOWER COST PER ACQUISITION" },
  { figure: "120M", unit: "+", label: "IMPRESSIONS DELIVERED" },
  { figure: "15,000", unit: "+", label: "LEADS GENERATED" },
];
