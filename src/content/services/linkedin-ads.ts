...
export const resultStats = [
  { figure: "4.0", unit: "x", label: "PIPELINE RETURN" },
  { figure: "25", unit: "%", label: "LOWER COST PER MQL" },
  { figure: "3,000", unit: "+", label: "B2B LEADS DELIVERED" },
  { figure: "20", unit: "%", label: "LEAD TO MEETING RATE" },
];
