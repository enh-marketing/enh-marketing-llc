...
export const growthCta = {
  heading: ["Ready to tell your brand story", "on screen?"] as [string, string],
  support:
    "Build Trust, Authority & Recognition With Professional Corporate Videos",
  button: "Connect With Corporate Video Experts",
};
 ...
 *  throughout, so "14 DAYS" is written here as the band already sets its units.
 *  The unit carries the brand accent, the value never does, which is why the
 *  two are separate fields. */
export const resultStats = [
  { figure: "150", unit: "+", label: "CORPORATE FILMS DELIVERED" },
  { figure: "18", unit: "+", label: "INDUSTRIES COVERED" },
  { figure: "14", unit: " Days", label: "AVERAGE DELIVERY" },
  { figure: "8M", unit: "+", label: "VIEWS GENERATED" },
];
