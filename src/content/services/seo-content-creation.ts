...
export const growthCta = {
  heading: ["Ready to rank with", "content that converts?"] as [string, string],
  support:
    "Drive Traffic, Authority & Leads With Our SEO Content Writing Experts",
  button: "Get Your SEO Content Plan",
};
...
export const resultStats = [
  { figure: "900", unit: "+", label: "ARTICLES PUBLISHED" },
  { figure: "130", unit: "%", label: "CONTENT TRAFFIC GROWTH" },
  { figure: "45", unit: "%", label: "KEYWORDS IN TOP 10" },
