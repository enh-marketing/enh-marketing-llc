...
export const growthCta = {
  heading: ["Ready to fill your pipeline", "with qualified leads?"] as [string, string],
  support:
    "Attract, Qualify & Convert High Intent B2B Leads With Our Lead Generation Experts",
  button: "Connect With B2B Lead Gen Experts",
};
...
export const resultStats = [
  { figure: "4,000", unit: "+", label: "QUALIFIED LEADS" },
  { figure: "22", unit: "%", label: "MEETING BOOK RATE" },
  { figure: "25", unit: "%", label: "LOWER COST PER SQL" },
  { figure: "15", unit: "+", label: "INDUSTRIES SERVED" },
];
