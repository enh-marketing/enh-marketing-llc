...
export const growthCta = {
  heading: ["Ready for a website", "that actually converts?"] as [string, string],
  support:
    "Fast, Beautiful & Built To Turn Visitors Into Paying Customers",
  button: "Connect With Web Design Experts",
};
 ...
 *  throughout, so "2.0S" is written here as the band already sets its units.
 *  The unit carries the brand accent, the value never does, which is why the
 *  two are separate fields. */
export const resultStats = [
  { figure: "180", unit: "+", label: "WEBSITES LAUNCHED" },
  { figure: "2.0", unit: "s", label: "AVERAGE LOAD TIME" },
  { figure: "85", unit: "/100", label: "MOBILE SPEED SCORE" },
  { figure: "30", unit: "%", label: "CONVERSION RATE UPLIFT" },
];
