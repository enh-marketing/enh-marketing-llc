...
export const growthCta = {
  heading: ["Ready to make your idea", "impossible to ignore?"] as [string, string],
  support:
    "Simplify Your Message & Convert More Viewers With Our Explainer Video Experts",
  button: "Connect With Explainer Video Experts",
};
 ...
 *  throughout, so "21 DAYS" is written here as the band already sets its units.
 *  The unit carries the brand accent, the value never does, which is why the
 *  two are separate fields. */
export const resultStats = [
  { figure: "100", unit: "+", label: "EXPLAINERS PRODUCED" },
  { figure: "25", unit: "%", label: "CONVERSION UPLIFT" },
  { figure: "65", unit: "%", label: "AVERAGE WATCH TIME" },
  { figure: "21", unit: " Days", label: "SCRIPT TO DELIVERY" },
];
