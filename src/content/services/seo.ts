...
export const services = {
  ...
  items: [
    ...
    },
    {
      ...
      title: "Ecommerce SEO",
      glyph: "catalogue",
      href: "/ecommerce-seo-agency-dubai",
    ...
    },
    {
      ...
      glyph: "creative",
      href: "/content-creation-in-dubai",
...
export const growthCta = {
  heading: ["Ready to own", "page one on Google?"] as [string, string],
  support:
    "Grow Rankings, Traffic & Qualified Leads With Our SEO Experts",
  button: "Connect With Dubai SEO Experts",
};
...
export const resultStats = [
  { figure: "120", unit: "%", label: "ORGANIC TRAFFIC GROWTH" },
  { figure: "1,200", unit: "+", label: "KEYWORDS ON PAGE 1" },
  { figure: "35", unit: "+", label: "BRANDS RANKED" },
  { figure: "25", unit: "%", label: "AVERAGE CTR UPLIFT" },
];
