...
export const resultStats = [
  { figure: "1,500", unit: "+", label: "PAGES OPTIMISED" },
  { figure: "30", unit: "%", label: "AVERAGE RANKING LIFT" },
  { figure: "25", unit: "%", label: "CTR IMPROVEMENT" },
  { figure: "80", unit: "%", label: "CORE WEB VITALS PASSED" },
];
