...
export const services = {
  ...
  items: [
    ...
    },
    {
      ...
      glyph: "ledger",
      href: "/testimonial-video-production",
    ...
    },
    {
      ...
      glyph: "conversation",
      href: "/interview-video-production",
...
export const growthCta = {
  heading: ["Ready to bring your", "brand to life on video?"] as [string, string],
  support:
    "From Concept To Final Cut, Handled End To End By Our Production Team",
  button: "Connect With Video Production Experts",
};
...
export const resultStats = [
  { figure: "600", unit: "+", label: "VIDEOS PRODUCED" },
  { figure: "25M", unit: "+", label: "TOTAL VIEWS" },
  { figure: "60", unit: "%", label: "AVERAGE COMPLETION RATE" },
  { figure: "45", unit: "+", label: "BRANDS FILMED" },
];
