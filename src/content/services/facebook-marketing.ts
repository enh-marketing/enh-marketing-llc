...
export const growthCta = {
  heading: ["Ready to grow your", "brand on Facebook?"] as [string, string],
  support:
    "Boost Reach, Engagement & Conversions With Our Facebook Marketing Experts",
  button: "Connect With Facebook Marketing Experts",
};
...
export const resultStats = [
  { figure: "5M", unit: "+", label: "MONTHLY REACH" },
  { figure: "80", unit: "%", label: "PAGE FOLLOWER GROWTH" },
  { figure: "3.0", unit: "%", label: "ENGAGEMENT RATE" },
  { figure: "40,000", unit: "+", label: "COMMUNITY MEMBERS" },
];
