...
import { SectorField } from "@/components/case-studies/SectorField";
import { masthead, formFields, type Study } from "@/content/case-studies";

/** THE OPENING.
 *
 *  WHY NOT ServiceHero. The seventeen service heroes open on a drawing of a
 *  service. This page's subject is twenty-two real engagements, so what stands
 *  beside the headline is the archive itself, tallied by sector: the reader
 *  learns what kind of company hires this agency before they have scrolled
 *  once, and every mark in it is a way into the work. The tri-tone headline,
 *  the aurora ground, the ruled paper, the button pair and the enquiry dialog
 *  are all ServiceHero's, so the page reads as the same site.
 *
 *  THE HEADLINE IS NOT "CASE STUDIES". That is the label in the menu the
 *  reader just clicked, and repeating it back is a wasted first line. What
 *  these twenty-two have in common is that each one ends in a figure somebody
 *  can check, so the headline says that instead.
 *
 *  THE <h1> CARRIES NO ENTRANCE ANIMATION. It is the largest text in the fold
 *  and the LCP element on this page, so it paints on the first frame. Same
 *  rule ServiceHero, ArticleHero and TestimonialHero follow. */
export function CaseMasthead({
  studies,
  activeSector,
  onSelectSector,
  breadcrumbs,
  ...
  return (
    <section
      id="masthead"
      data-section="Case Studies Masthead"
    ...
    >
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        {/* The ruled ground of a record book, the same paper the testimonials
            page and the article header stand on. This page is a record too. */}
        <div
        ...
        <div className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-16">
          <div className="min-w-0">
            ...
            <p className="mb-6 text-xs font-semibold uppercase text-brand-text">
              (00) {studies.length} engagements, with the figures attached
            </p>
