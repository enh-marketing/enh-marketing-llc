...
/*                                                                            */
/*  THE VIDEO AND POSTER ARE THE COMPONENT'S OWN DEFAULTS, served from        */
/*  jsDelivr out of the author's GitHub repo. They are not ours and not on    */
/*  our origin; the `videoSrc` and `posterSrc` props replace them whenever    */
/*  there is footage to use. The default copy is the component's too.         */
/*                                                                            */
