...
const aiHub: NavNode = {
  ...
  children: [
    ...
    { label: "Campaign Intelligence", href: "/ai-campaign-intelligence-dubai" },
    { label: "Intelligent Web", href: "/ai-website-development-dubai" },
    { label: "Data & Dashboards", href: "/ai-data-dashboard-services-dubai" },
...
const BUILT = new Set([
  ...
  "/ai-campaign-intelligence-dubai",
  "/ai-search-visibility-dubai",
  "/ai-data-dashboard-services-dubai",
